  ...
  return (
    <div className="mb-6 text-center">
      ...
      {gameState.selectedPiece && (
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 mb-4 p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-200">
      ...
      {gameState.winner !== null && (
        <button
          onClick={onRestart}
          className="mt-4 px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition-all shadow-sm"
        >
          Neues Spiel
        </button>
      )}
